...
export const siteConfig: SiteConfig = {
  language: "en",
  title: "FocusGap | Join the VIP List — 40% Off Early Access",
  description: "The modular desk system that brings order to your workspace. Join 500+ VIPs for 40% off on Kickstarter launch.",
};
...
export const heroConfig: HeroConfig = {
  ...
  ctaText: "JOIN THE VIP LIST — GET 40% OFF",
